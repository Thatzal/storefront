...
enum DateTimeRangePickerModeUpdateOffer {
  time,
  date,
  dateAndTime,
}

class DateTimeRangePickerUpdateOffer {
  final startText;
  final endText;
  final doneText;
  final cancelText;
  final bool use24hFormat;
  final DateTimeRangePickerModeUpdateOffer mode;
  final type;
  ...
  DateTimeRangePickerUpdateOffer({
    ...
    this.mode = DateTimeRangePickerModeUpdateOffer.dateAndTime,
    this.interval = 15,
  ...
  void showPicker(BuildContext context) {
    ...
    if (initialEndTime == null) {
      initialEndTime = initialStartTime!.add(Duration(
          days: mode == DateTimeRangePickerModeUpdateOffer.time ? 0 : 1,
          hours: mode == DateTimeRangePickerModeUpdateOffer.time ? 2 : 0));
    }
    ...
    switch (mode) {
      case DateTimeRangePickerModeUpdateOffer.date:
        {
          pickerMode = CupertinoDatePickerMode.date;
        }
        break;

      case DateTimeRangePickerModeUpdateOffer.time:
        {
                    ...
                    child: TabBarView(
                      ...
                      children: widget._tabs.map((Tab tab) {
                        ...
                        return CupertinoDatePicker(
                          ...
                          minimumDate: tab.text == widget._tabs.first.text ? widget._minimumTime:isChangeFromDate? TempFromDateTime:widget._minimumTime,
