...
enum OfferConditionTimePickerMode {
  time,
  date,
  dateAndTime,
}

class OfferConditionTimePicker {
  final startText;
  final endText;
  final doneText;
  final cancelText;
  final bool use24hFormat;
  final OfferConditionTimePickerMode mode;
  final type;
  ...
  OfferConditionTimePicker({
    ...
    this.mode = OfferConditionTimePickerMode.dateAndTime,
    this.interval = 15,
  ...
  void showPicker(BuildContext context) {
    ...
    if (initialEndTime == null) {
      initialEndTime = initialStartTime!.add(Duration(
          days: mode == OfferConditionTimePickerMode.time ? 0 : 1,
          hours: mode == OfferConditionTimePickerMode.time ? 2 : 0));
    }
    ...
    switch (mode) {
      case OfferConditionTimePickerMode.date:
        {
          pickerMode = CupertinoDatePickerMode.date;
        }
        break;

      case OfferConditionTimePickerMode.time:
        {
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return FractionallySizedBox(
            widthFactor: ResponsiveHelper.isMobile(context)?0.9:0.5,
