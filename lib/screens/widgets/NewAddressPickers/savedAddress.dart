...
import 'package:socialapps/screens/widgets/NewAddressPickers/AddAddressFromMapScreen.dart';
      ...
      body: responsiveContainer(context, ResponsiveHelper.isMobile(context)? Constants.newBackground : Constants.tabBackGroundColor,
          Scaffold(
            ...
            appBar: AppBar(
              ...
              titleSpacing: 5,
              title:Text("Select a location",style: AppBarTitle),
              toolbarHeight: 50,
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        if(permissionNotificationStatus.isGranted){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddAddressFromMap("${ApiUrls.mapKey}",SaveAddressIsEmpty:GetAdressList.isEmpty?"yes":"no"))).then((value) {
                            load();
                            getSaveAddress();
                          });
                        }else {
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return GestureDetector(
                            onTap: (){
                              ...
                              Navigator.pop(context, "${data.descriptionLine1},${data.landmark}, ${data.area},${data.pincode}",);
