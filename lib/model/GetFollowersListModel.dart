...
class GetFollowersListModel {
  ...
  GetFollowersListModel.fromJson(dynamic json) {
    _status = json['status'];
    _message = json['message'];
    if (json['result'] != null) {
      _result = [];
      json['result'].forEach((v) {
        _result?.add(GetFollowersResult.fromJson(v));
      });
    }
  }
  String? _status;
  String? _message;
  List<GetFollowersResult>? _result;
GetFollowersListModel copyWith({  String? status,
  String? message,
  List<GetFollowersResult>? result,
}) => GetFollowersListModel(  status: status ?? _status,
  message: message ?? _message,
  result: result ?? _result,
);
  String? get status => _status;
  String? get message => _message;
  List<GetFollowersResult>? get result => _result;
...
class GetFollowersResult {
  ...
  GetFollowersResult.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _modified;
GetFollowersResult copyWith({  num? id,
  num? followers,
  num? following,
  dynamic displayname,
  String? phonenumber,
