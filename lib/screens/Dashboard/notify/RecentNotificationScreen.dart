...
class RecentNotificationScreen extends StatefulWidget {
  List<NotificationListModel> RecentNotificationDataList;
  bool recentNotificationLoader;
  RecentNotificationScreen({Key? key ,required this.recentNotificationLoader,required this.RecentNotificationDataList}) : super(key: key);

  @override
  State<RecentNotificationScreen> createState() => _RecentNotificationScreenState();
}

class _RecentNotificationScreenState extends State<RecentNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: widget.recentNotificationLoader ==true?const Center(child: LoadingWidget()):widget.RecentNotificationDataList.isEmpty?   Center(
      ...
      Stack(
        children: [
            ...
            shrinkWrap: true,
            itemCount: widget.RecentNotificationDataList.length,
            itemBuilder: (context, index) {
             // List<NotificationListModel> reversedList = widget.RecentNotificationDataList.reversed.toList();
              var data = widget.RecentNotificationDataList[index];
