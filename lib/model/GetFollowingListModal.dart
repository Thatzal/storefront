...
/// result : [{"id":1,"followers":2,"following":2,"displayname":null,"phonenumber":"3698521477","username":"b'Tm9uZQ=='","email":null,"profile_picture":null,"page_picture":null,"desc":null,"placeORperson":"person","businessORpublic":"public","classification":null,"movable":false,"addressORarea":"address","operatingaddress":null,"maritalstatus":"single","passportnumber":null,"dateofissue":null,"nationality":null,"dateofbirth":null,"gender":"M","religion":null,"subreligion":null,"caste":null,"subsect":null,"search_page_position_preferences":"TRENDING OFFERS","Offering_area_preference":null,"Offer_Category_preference":null,"Offer_Segment_preference":null,"Offer_Sub_Segment_preference":null,"Current_Location":null,"Want_to_Buy":false,"Want_to_sell":false,"Opt_Delivery":false,"Close_Confirmed_Offers":false,"Ok_for_Current_location_Offers":false,"Offer_match_percentage":"0.00","mean_computed_rating":0,"numberofcomputations":0,"mean_user_rating":0,"numberofusers_rating":0,"blocked":"NO","blockedtime":null,"subscription_status":"FREE","payment_done":null,"payment_date":null,"created_at":"14-05-2023 09:56","modified":"14-05-2023 09:56"},{"id":2,"followers":1,"following":1,"displayname":null,"phonenumber":"7999677654","username":null,"email":null,"profile_picture":null,"page_picture":null,"desc":null,"placeORperson":"person","businessORpublic":"public","classification":null,"movable":false,"addressORarea":"address","operatingaddress":null,"maritalstatus":"single","passportnumber":null,"dateofissue":null,"nationality":null,"dateofbirth":null,"gender":"M","religion":null,"subreligion":null,"caste":null,"subsect":null,"search_page_position_preferences":"TRENDING OFFERS","Offering_area_preference":null,"Offer_Category_preference":null,"Offer_Segment_preference":null,"Offer_Sub_Segment_preference":null,"Current_Location":null,"Want_to_Buy":false,"Want_to_sell":false,"Opt_Delivery":false,"Close_Confirmed_Offers":false,"Ok_for_Current_location_Offers":false,"Offer_match_percentage":"0.00","mean_computed_rating":0,"numberofcomputations":0,"mean_user_rating":0,"numberofusers_rating":0,"blocked":"NO","blockedtime":null,"subscription_status":"FREE","payment_done":null,"payment_date":null,"created_at":"15-05-2023 11:18","modified":"15-05-2023 11:18"},{"id":3,"followers":2,"following":2,"displayname":null,"phonenumber":"9966863523","username":"demo1","email":null,"profile_picture":null,"page_picture":null,"desc":null,"placeORperson":"person","businessORpublic":"public","classification":null,"movable":false,"addressORarea":"address","operatingaddress":null,"maritalstatus":"single","passportnumber":null,"dateofissue":null,"nationality":null,"dateofbirth":null,"gender":"M","religion":null,"subreligion":null,"caste":null,"subsect":null,"search_page_position_preferences":"TRENDING OFFERS","Offering_area_preference":null,"Offer_Category_preference":null,"Offer_Segment_preference":null,"Offer_Sub_Segment_preference":null,"Current_Location":null,"Want_to_Buy":false,"Want_to_sell":false,"Opt_Delivery":false,"Close_Confirmed_Offers":false,"Ok_for_Current_location_Offers":false,"Offer_match_percentage":"0.00","mean_computed_rating":0,"numberofcomputations":0,"mean_user_rating":0,"numberofusers_rating":0,"blocked":"NO","blockedtime":null,"subscription_status":"FREE","payment_done":null,"payment_date":null,"created_at":"15-05-2023 11:18","modified":"15-05-2023 11:22"}]

class GetFollowingListModal {
  GetFollowingListModal({
      String? status, 
      String? message, 
      List<GetFollowingResult>? result,}){
    _status = status;
    _message = message;
    _result = result;
}

  GetFollowingListModal.fromJson(dynamic json) {
    _status = json['status'];
    _message = json['message'];
    if (json['result'] != null) {
      _result = [];
      json['result'].forEach((v) {
        _result?.add(GetFollowingResult.fromJson(v));
      });
    }
  }
  String? _status;
  String? _message;
  List<GetFollowingResult>? _result;
GetFollowingListModal copyWith({  String? status,
  String? message,
  List<GetFollowingResult>? result,
}) => GetFollowingListModal(  status: status ?? _status,
  message: message ?? _message,
  result: result ?? _result,
);
  String? get status => _status;
  String? get message => _message;
  List<GetFollowingResult>? get result => _result;
...
class GetFollowingResult {
  ...
  GetFollowingResult.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _modified;
GetFollowingResult copyWith({  num? id,
  num? followers,
  num? following,
  dynamic displayname,
  String? phonenumber,
