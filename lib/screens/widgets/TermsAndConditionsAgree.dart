...
class TermsAndConditionAgree extends StatefulWidget {
  String From;
   TermsAndConditionAgree({Key? key,required this.From}) : super(key: key);

  @override
  State<TermsAndConditionAgree> createState() => _TermsAndConditionAgreeState();
}

class _TermsAndConditionAgreeState extends State<TermsAndConditionAgree> {
  @override
  void initState() {
  ...
  loadTC(){
    DrawAuraAPi.getTermsConditionsApi().then((value) {
     if(mounted) {
       setState(() {
