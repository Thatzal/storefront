                                                ...
                                                children: [
                                                      ...
                                                      children:  [
                                                        RichText(
                                                            ...
                                                            children: [
                                                              ...
                                                              TextSpan(text: " ${data.offerData!.segment!.name.toString()} ${data.offerData!.subsegment!.name.toString()}, ${data.offerData!.subscribers!.displayname.toString()} ${data.offerData!.offerItems!.first.name.toString()} ${data.offerData!.offerItems!.first.price.toString()} / ${data.offerData!.offerItems!.first.unit!.name.toString()}",style: editTextStyle,),
                                                            ]
                                                        )),
                                                        5.height,
                                                        Text("${data.offerData!.offerConditions!.periodicity}, ${data.offerData!.offerConditions!.priority}, ${data.offerData!.addres}",style: BlackDescStyleBold,overflow: TextOverflow.ellipsis,maxLines: 5,),
                                                        const SizedBox(height: 5,),
                                                        Container(
                                                            width: ResponsiveHelper.isMobile(context)?width*0.5:tabWidth*0.5,
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text.rich(
                                                        ...
                                                        TextSpan(
                                                        text:"${data.offerCounters!.last.counter![0].tabactivity.toString()}" == "QUERY" ? "Queried by " : 
                                                        ("${data.offerCounters!.last.counter![0].tabactivity.toString()}" == "EXECUTE" ? "Executed by " :
                                                        ("${data.offerCounters!.last.counter![0].tabactivity.toString()}" == "SIGN-OFF" ? "Signed off by " : 
                                                        "${data.offerCounters!.last.counter![0].tabactivity.toString().capitalise()}" + "ed by ")), 
                                                            style:greyHintStyle,
                                                            children: <InlineSpan>[
                                                              TextSpan(
