...
//
// class GetSubscriberFavouriteOfferModal {
//   GetSubscriberFavouriteOfferModal({
//       num? status,
//       String? message,
//       List<GetFavouriteOfferResult>? result,}){
//     _status = status;
//     _message = message;
//     _result = result;
// }
//
//   GetSubscriberFavouriteOfferModal.fromJson(dynamic json) {
//     _status = json['status'];
//     _message = json['message'];
//     if (json['result'] != null) {
//       _result = [];
//       json['result'].forEach((v) {
//         _result?.add(GetFavouriteOfferResult.fromJson(v));
//       });
//     }
//   }
//   num? _status;
//   String? _message;
//   List<GetFavouriteOfferResult>? _result;
// GetSubscriberFavouriteOfferModal copyWith({  num? status,
//   String? message,
//   List<GetFavouriteOfferResult>? result,
// }) => GetSubscriberFavouriteOfferModal(  status: status ?? _status,
//   message: message ?? _message,
//   result: result ?? _result,
// );
//   num? get status => _status;
//   String? get message => _message;
//   List<GetFavouriteOfferResult>? get result => _result;
//
...
//
// class GetFavouriteOfferResult {
//   GetFavouriteOfferResult({
//       num? id,
...
// }
//
//   GetFavouriteOfferResult.fromJson(dynamic json) {
//     _id = json['id'];
...
// GetFavouriteOfferResult copyWith({  num? id,
//   OfferConditions? offerConditions,
//   List<OfferItems>? offerItems,
//   String? addres,
//   String? offerareas,
...
//   Segment? segment,
//   Subsegment? subsegment,
// }) => GetFavouriteOfferResult(  id: id ?? _id,
