...
//
//
// class NormalPlacePickerScreen extends StatefulWidget {
//
//   final String apiKey;
//
//
...
//
//   NormalPlacePickerScreen(this.apiKey,
...
//
//   @override
//   State<StatefulWidget> createState() => NormalPlacePickerScreenState();
// }
//
// /// Place picker state
// class NormalPlacePickerScreenState extends State<NormalPlacePickerScreen> {
...
//                             Navigator.of(context).pop(this.locationResult?.name == null ?"": "${this.locationResult?.name}, ${this.locationResult?.locality}");
//                             // if (Platform.isAndroid) {
//                             //   _delayedPop();
//                             // } else {
//                             //   Navigator.of(context).pop("${this.locationResult?.name}, ${this.locationResult?.locality}");
//                             // }
//                           }, widget.localizationItem!.tapToSelectLocation),
//                           Divider(height: 8),
//                           Padding(
//                             child: Text(widget.localizationItem!.nearBy, style: BlackHeadingStyle),
...
//                 SizedBox(width: 24),
//                 Expanded(
//                     child: Text(widget.localizationItem!.findingPlace, style: BlackHeadingStyle))
//               ],
//             ),
//           ),
//         ),
