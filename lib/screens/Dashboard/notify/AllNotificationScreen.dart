...
class AllNotificationScreen extends StatefulWidget {
  List<NotificationListModel> AllNotificationDataList;
  bool AllNotificationLoader;
  AllNotificationScreen({Key? key,required this.AllNotificationDataList,required this.AllNotificationLoader}) : super(key: key);
...
class _AllNotificationScreenState extends State<AllNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: widget.AllNotificationLoader==true? Center(child: LoadingWidget()):widget.AllNotificationDataList.isEmpty?   Center(
      ...
      Stack(
        children: [
            ...
            shrinkWrap: true,
            itemCount: widget.AllNotificationDataList.length,
            itemBuilder: (context, index) {
              List<NotificationListModel> reversedList = widget.AllNotificationDataList.reversed.toList();
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            //         },
                            //         children:[
                            //           TextSpan(text:' ${data.notifyingMessage.toString()}',style: TextStyle(fontSize: 13,fontFamily: "Roboto400",color: Colors.black,fontStyle: FontStyle.italic,height: 1.2)),
