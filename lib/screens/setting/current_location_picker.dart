...
import 'package:socialapps/model/GetAdressListModal.dart';
...
import 'manage_adress_screen.dart';
import 'package:socialapps/common/ResponsiveBuilder.dart';



class CurrentPlacePicker extends StatefulWidget {
  ...
  String from;
  String SaveAddressIsEmpty;
  bool isOfferCreating;
  CurrentPlacePicker(this.apiKey,
      {this.displayLocation, this.localizationItem, LatLng? defaultLocation,required this.from,required this.SaveAddressIsEmpty ,required this.isOfferCreating}) {
  ...
  @override
  State<StatefulWidget> createState() => CurrentPlacePickerState();
}

/// Place picker state
class CurrentPlacePickerState extends State<CurrentPlacePicker> {
...
/// Enter addresss
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            CurrentLocationSelectPlaceAction(getLocationName(), () {
                                ...
                                widget.from !="AddAddress"? "Tap to confirm button for this location":"Tap here for this location"),
                            SizedBox(height: 10,),
                            widget.from=="AddAddress"?
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ElevatedButton(
                                    onPressed: (){
                                      ...
                                      areaController.text =    " ${  this.locationResult!.subLocalityLevel1!.name == null ?"": "${this.locationResult!.subLocalityLevel1!.name},"} ";
                                      cityController.text =  " ${ this.locationResult!.locality == null ?"": "${this.locationResult!.locality.toString()},"} ";
                                      stateController.text =
                                      "${this.locationResult!.city!.name == null ? "": "${ this.locationResult!.city!.name.toString()},"}"
                                          "${this.locationResult!.administrativeAreaLevel1!.name == null ? "": "${this.locationResult!.administrativeAreaLevel1!.name.toString()},"}"
                                          "${this.locationResult!.postalCode == null ? "": "${this.locationResult!.postalCode.toString()},"}"
                                          "${ this.locationResult!.country!.name == null ? "": this.locationResult!.country!.name.toString()}";

                                      // pinCodeController.text = "";
                                      // areaController.text =
                                      // " ${  this.locationResult!.subLocalityLevel1!.name == null ?"": "${this.locationResult!.subLocalityLevel1!.name},"} "
                                      //     " ${ this.locationResult!.locality == null ?"": "${this.locationResult!.locality.toString()},"} "
                                      //     "${this.locationResult!.city!.name == null ? "": "${ this.locationResult!.city!.name.toString()},"}"
                                      //     "${this.locationResult!.administrativeAreaLevel1!.name == null ? "": "${this.locationResult!.administrativeAreaLevel1!.name.toString()},"}"
                                      //      "${ this.locationResult!.postalCode == null ? "": "${this.locationResult!.postalCode.toString()},"}"
                                      //     "${ this.locationResult!.country!.name == null ? "": this.locationResult!.country!.name.toString()}";
                                      ...
                                      _getSaveAddressBottomSheet(context);
                                      // areaController.clear();
                                      // pinCodeController.clear();
                                      // cityController.clear();
                                      // stateController.clear();
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        fixedSize: Size(ResponsiveHelper.isMobile(context)?MediaQuery.of(context).size.width*0.9:ResponsiveHelper.TabModeWidth*0.9, 48),
                                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))
                                    ),
                                    child: Text("Enter complete address",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500,fontSize: 18),)),
                              ],
                            )
                                :   Row(
                              mainAxisAlignment: MainAxisAlignment.center,
  ...
  void _getSaveAddressBottomSheet(BuildContext context) async{
                        ...
                        Expanded(
                            ...
                            ListView(
                              ...
                              children: [
                                ...
                                isAddressSaveAsOther==true? SizedBox(height: 15,):SizedBox(),
                                TextFormField(
                                ...
                                TextFormField(
                                  ...
                                  decoration: commanInputDecoration(hint:"Address 2",isOptional: false,label:" Address 2"),
                                ),
                                const SizedBox(height: 15,),
                                TextFormField(
                                  // maxLines: null,
                                  ...
                                  decoration: commanInputDecoration(hint:"Address 3",isOptional: false,label:" Address 3"),
                                ),
                               // ),
        ...
        for (dynamic t in predictions) {
          ...
          suggestions.add(RichSuggestion(aci, () {
            FocusScope.of(context).requestFocus(FocusNode());
             decodeAndSelectPlace(aci.id!,t['description']);
            print("_getSaveAddressBottomSheet");
  ...
  void decodeAndSelectPlace(String placeId,String PlaceDes) async {
    clearOverlay();
    ...
    try {
      ...
      if (mapController.isCompleted) {
        moveToLocationForFillAddress(LatLng(location['lat'], location['lng']),PlaceDes);
      }
    } catch (e) {
      print(e);
    }
  ...
  void reverseGeocodeLatLngForAddressFill(LatLng latLng,String PlaceDes) async {
    try {
      ...
      setState(() {
        ...
        areaController.text = value1.toString();
        cityController.text = value2.toString();
        stateController.text =
        "${this.locationResult!.city!.name == null ? "": "${ this.locationResult!.city!.name.toString()},"}"
            "${this.locationResult!.administrativeAreaLevel1!.name == null ? "": "${this.locationResult!.administrativeAreaLevel1!.name.toString()},"}"
            "${this.locationResult!.postalCode == null ? "": "${this.locationResult!.postalCode.toString()},"}"
  ...
  /// match the location.
  void moveToLocationForFillAddress(LatLng latLng,String PlaceDes) {
    ...
    reverseGeocodeLatLngForAddressFill(latLng,PlaceDes);
