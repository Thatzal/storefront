...
class AddAddressFromMap extends StatefulWidget {
  ...
  AddAddressFromMap(this.apiKey,
      {this.displayLocation, this.localizationItem, LatLng? defaultLocation,required this.SaveAddressIsEmpty}) {
  ...
  @override
  State<StatefulWidget> createState() => AddAddressFromMapState();
}

/// Place picker state
class AddAddressFromMapState extends State<AddAddressFromMap> {
  ...
  void decodeAndSelectPlace(String placeId,String PlaceDes) async {
    ...
    try {
      ...
      if (mapController.isCompleted) {
        ...
        moveToLocationForFill(LatLng(location['lat'], location['lng']),PlaceDes);
  ...
  void reverseGeocodeLatLngForFill(LatLng latLng,String PlaceDes) async {
    try {
  ...
  /// match the location.
  void moveToLocationForFill(LatLng latLng,String PlaceDes) {
    ...
    reverseGeocodeLatLngForFill(latLng,PlaceDes);
