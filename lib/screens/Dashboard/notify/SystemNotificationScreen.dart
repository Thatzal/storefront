...
class SystemNotificationScreen extends StatefulWidget {
  List<NotificationListModel> SystemNotificationDataList;
  bool SystemNotificationLoader;
  SystemNotificationScreen({Key? key,required this.SystemNotificationDataList,required this.SystemNotificationLoader}) : super(key: key);

  @override
  State<SystemNotificationScreen> createState() => _SystemNotificationScreenState();
}
...
class _SystemNotificationScreenState extends State<SystemNotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: widget.SystemNotificationLoader==true?const Center(child: LoadingWidget()):widget.SystemNotificationDataList.isEmpty?   Center(
      ...
      Stack(
        children: [
            ...
            shrinkWrap: true,
            itemCount: widget.SystemNotificationDataList.length,
            itemBuilder: (context, index) {
              List<NotificationListModel> reversedList = widget.SystemNotificationDataList.reversed.toList();
