...
/// profile_picture : "/media/profile/IMG20230621185401.jpg"
...
/// modified : "21-06-2023 18:55"

class getSubscriberDetailsResult {
  getSubscriberDetailsResult({
      num? id, 
      num? followers, 
      num? following, 
      String? displayname, 
  ...
  getSubscriberDetailsResult.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _modified;
getSubscriberDetailsResult copyWith({  num? id,
  num? followers,
  num? following,
  String? displayname,
  String? phonenumber,
  ...
  String? createdAt,
  String? modified,
}) => getSubscriberDetailsResult(  id: id ?? _id,
