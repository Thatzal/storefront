...
class IntermediateCounterOfferDataModel {
  IntermediateCounterOfferDataModel({
      List<Counter>? counter,}){
    _counter = counter;
}

  IntermediateCounterOfferDataModel.fromJson(dynamic json) {
...
IntermediateCounterOfferDataModel copyWith({  List<Counter>? counter,
}) => IntermediateCounterOfferDataModel(  counter: counter ?? _counter,
);
